 ...
 * 
 * Note: the C++ bindings use std::mesa_call_once and therefore may need to be
...
{
private:
    static std::mesa_once_flag default_initialized_;
...
public:
    ...
    */
    ...
    {
        std::mesa_call_once(default_initialized_, makeDefault);
    ...
    */
    ...
    {
        std::mesa_call_once(default_initialized_, makeDefaultProvided, std::cref(default_device));
        detail::errHandler(default_error_);
        return default_;
    }
...
CL_HPP_DEFINE_STATIC_MEMBER_ std::mesa_once_flag Device::default_initialized_;
...
private:
    ...
    */
    static void makeDefault() {
        /* Throwing an exception from a mesa_call_once invocation does not do
...
public:
    ...
    */
    ...
    {
        std::mesa_call_once(default_initialized_, makeDefaultProvided, std::cref(default_platform));
        detail::errHandler(default_error_);
        return default_;
    }
...
CL_HPP_DEFINE_STATIC_MEMBER_ std::mesa_once_flag Platform::default_initialized_;
...
public:
    ...
    */
    ...
    {
        std::mesa_call_once(default_initialized_, makeDefaultProvided, std::cref(default_context));
        detail::errHandler(default_error_);
        return default_;
    }
...
CL_HPP_DEFINE_STATIC_MEMBER_ std::mesa_once_flag Context::default_initialized_;
...
public:
    ...
    */
    ...
    {
        std::mesa_call_once(default_initialized_, makeDefaultProvided, std::cref(default_queue));
        detail::errHandler(default_error_);
        return default_;
    }
...
CL_HPP_DEFINE_STATIC_MEMBER_ std::mesa_once_flag CommandQueue::default_initialized_;
