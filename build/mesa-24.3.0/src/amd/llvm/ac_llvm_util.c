...
{
   static mesa_once_flag ac_init_llvm_target_once_flag = MESA_ONCE_FLAG_INIT;
   mesa_call_once(&ac_init_llvm_target_once_flag, ac_init_llvm_target);
}

#if !LLVM_IS_SHARED
static mesa_once_flag ac_init_static_llvm_target_once_flag = MESA_ONCE_FLAG_INIT;
static void ac_init_static_llvm_once(void)
{
   mesa_call_once(&ac_init_static_llvm_target_once_flag, ac_init_llvm_target);
}
#endif
