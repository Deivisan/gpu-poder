...
static_assert(sizeof(mesa_once_flag) == sizeof(INIT_ONCE), "The size of mesa_once_flag must equal to INIT_ONCE");
...
// 7.25.2.1
void
mesa_call_once(mesa_once_flag *flag, void (*func)(void))
{
    assert(flag && func);
